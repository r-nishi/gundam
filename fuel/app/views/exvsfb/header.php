...
<nav class="drawer-nav" role="navigation">
  <ul class="drawer-menu">
    <li><a class="drawer-brand" href="<?php echo URL_EXVSFB ?>"><?php echo EXVSFB ?></a></li>
    <li class="drawer-dropdown">
      <a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false">
        <?php echo COST_3000 ?> <span class="drawer-caret"></span>
      </a>
      <ul class="drawer-dropdown-menu">
        <li><a class="drawer-dropdown-menu-item" href="<?php echo URL_EXVSFB ?>/turnx"><?php echo TURN_X ?></a></li>
        <li><a class="drawer-dropdown-menu-item" href="<?php echo URL_EXVSFB ?>/bansheenorn"><?php echo BANSHEE_NORN ?></a></li>
      </ul>
    </li>
    <li class="drawer-dropdown">
      <a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false">
